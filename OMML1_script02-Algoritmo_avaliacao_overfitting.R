...
set.seed(123)
bool_treino <- stats::runif(dim(titanic)[1])>.25 # Vai gerar um vetor com valores aleatorios
table(bool_treino) # TRUE: Base de Treino e FALSE: Base de Teste
...
# Arvore com profundidade alta > COMPLEXA!
set.seed(123)
