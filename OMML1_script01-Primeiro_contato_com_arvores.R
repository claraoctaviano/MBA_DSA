...
# Se não colocar method='class', ele funciona para variável contínua. 
arvore
...
# Verificando quais são as variáveis mais importantes no modelo
# Sex e Fare são as variáveis mais importantes.
